    ...
    if (requiresClientGuiCapture()) {
      {
        ...
        const command = [
          ...
          "MINELINK_E2E_QUIESCE_REPO_TASKS=1",
          "MINELINK_RECORD_CLIENT=1",
          "MINELINK_GRADLE_JVMARGS='-Xmx768m -XX:MaxMetaspaceSize=512m'",
          "MINELINK_NEOFORGE_LOG_LEVEL=INFO",
          "MINELINK_NEOFORGE_LOG_MARKERS=''",
          ...
          "MINELINK_RECORDER_POST_SCENARIO_SECONDS=4",
          "MINELINK_RECORDER_MIN_WORK_VISIBLE_SECONDS=10",
          "MINELINK_RECORDER_MINING_VISIBLE_MS=2500",
          "MINELINK_RECORDER_CAMERA_DISTANCE=6.0",
          "MINELINK_RECORDER_CAMERA_HEIGHT=3.2",
          "MINELINK_RECORDER_CAMERA_SIDE=2.0",
          "MINELINK_RECORDER_CAMERA_LEAD=0.9",
          "MINELINK_RECORDER_CAMERA_SMOOTHING=0.12",
          "MINELINK_RECORDER_FOLLOW_INTERVAL_TICKS=20",
          "MINELINK_RECORDER_CLIENT_CAMERA_MODE=observer_follow",
          "MINELINK_RECORDER_CLIENT_CAMERA_DISTANCE=6.0",
          ...
          "MINELINK_RECORDER_CLIENT_CAMERA_SMOOTHING=0.12",
