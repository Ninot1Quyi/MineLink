...
start_recorder_client() {
  ...
  case "$scenario" in
    portal_coop)
      export MINELINK_RECORDER_EXPECTED_VISIBLE_AGENTS="${MINELINK_RECORDER_EXPECTED_VISIBLE_AGENTS:-3}"
      export MINELINK_AGENT_TURN_DELAY_MS="${MINELINK_AGENT_TURN_DELAY_MS:-200}"
      ;;
    *)
      export MINELINK_RECORDER_EXPECTED_VISIBLE_AGENTS="${MINELINK_RECORDER_EXPECTED_VISIBLE_AGENTS:-1}"
      ;;
  esac
  ...
  export MINELINK_RECORDER_CLIENT_GAME_DIR="$recorder_client_game_dir"
  {
    ...
    echo "MINELINK_RECORDER_EXPECTED_VISIBLE_AGENTS=$MINELINK_RECORDER_EXPECTED_VISIBLE_AGENTS"
