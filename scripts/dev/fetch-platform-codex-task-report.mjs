...
function salvageScript() {
  return [
    ...
    '  case "$status" in',
    '    *D*)',
    '      echo "Refusing task report salvage: deletion is not allowed for \'$path\'." >&2',
    "      exit 24",
    "      ;;",
    "  esac",
    '  case "$path" in',
    '    "$report_path"|docs/agent-factory-canaries/*.md|docs/minelink-acceptance.md)',
    '      printf "%s\\n" "$path" >> "$allowed_paths_file"',
    "      ;;",
    "    *)",
