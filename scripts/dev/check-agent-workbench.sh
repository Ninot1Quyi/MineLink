...
require_text ".github/workflows/ona-platform-codex-probe.yml" "--agent-mode AGENT_MODE_RALPH"
...
require_text ".devcontainer/Dockerfile" "command -v Xvfb"
...
require_text "scripts/dev/bootstrap-prebuild.sh" "python3-pil"
...
require_text ".ona/automations.yaml" "MINELINK_PREBUILD_SKIP_GRADLE=1"
...
require_text "scripts/dev/bootstrap-prebuild.sh" "prebuild-cache-state.md"
require_text "scripts/dev/bootstrap-prebuild.sh" "verify_prewarmed_gradle_cache"
require_text "scripts/dev/bootstrap-prebuild.sh" "verifying prewarmed Gradle/NeoForge cache"
...
require_text "scripts/dev/start-ona-platform-codex.mjs" "AGENT_MODE_RALPH"
...
require_text "scripts/dev/check-platform-codex-evidence.mjs" "AGENT_MODE_RALPH"
