...
require_text ".github/workflows/github-user-attachment-smoke.yml" "MINELINK_GITHUB_USER_ATTACHMENTS_COOKIE"
...
require_text "scripts/dev/publish-github-video-local.mjs" "dedicated local Chrome profile"
