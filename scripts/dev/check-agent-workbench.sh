...
require_text "ona/ai-automations/minelink-agent-factory.yaml" "Commit: <current git commit"
...
require_text "ona/ai-automations/minelink-agent-factory.yaml" "Identity: I am Codex running in Ona Platform Codex"
